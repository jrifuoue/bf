 ...
 *
 * Kernel-private debug config. This header shadows the shared config_debug.h
...
/* Include the shared debug config from the root build */
#include "/workspaces/bf/tilck/build/tilck_gen_headers/config_debug.h"

/* --------- Kernel-private boolean config variables --------- */

/* enabled by default */
#define KRN_TRACK_NESTED_INTERR 1
#define KERNEL_SELFTESTS 1
#define KRN_STACK_ISOLATION 1
#define KRN_SYMBOLS 1

/* opt-in debug features */
#define KRN_HANG_DETECTION 0
