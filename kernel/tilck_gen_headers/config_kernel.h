...
#include "/workspaces/bf/tilck/build/tilck_gen_headers/config_kernel.h"

/* --------- Kernel-private boolean config variables --------- */
#define KRN_NO_SYS_WARN 0
#define KRN_PAGE_FAULT_PRINTK 0
#define KRN_TINY_KERNEL 0
#define KERNEL_GCOV 0
#define KERNEL_UBSAN 0
#define KRN32_LIN_VADDR 1
