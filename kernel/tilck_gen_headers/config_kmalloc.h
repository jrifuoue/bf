...
#define KRN_KMALLOC_FREE_MEM_POISONING 0
#define KRN_KMALLOC_HEAVY_STATS 0
#define KRN_KMALLOC_SUPPORT_DEBUG_LOG 0
#define KRN_KMALLOC_SUPPORT_LEAK_DETECTOR 0
