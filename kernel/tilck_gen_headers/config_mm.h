 ...
 *
 * Kernel-private MM config. This header shadows the shared config_mm.h
...
/* Include the shared MM config from the root build */
#include "/workspaces/bf/tilck/build/tilck_gen_headers/config_mm.h"

/* ------ Value-based config variables -------- */

#define KRN_USER_STACK_PAGES       16
