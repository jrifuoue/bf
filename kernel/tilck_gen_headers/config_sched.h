...
#define KRN_TIMER_HZ                   250
#define KRN_SCHED_LATENCY_TICKS        20
#define KRN_MIN_GRANULARITY_TICKS      2

/* --------- Boolean config variables --------- */
#define KRN_RESCHED_ENABLE_PREEMPT 0
#define KRN_MINIMAL_TIME_SLICE 0
